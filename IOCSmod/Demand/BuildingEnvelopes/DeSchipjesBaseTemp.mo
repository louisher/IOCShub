...
model DeSchipjesBaseTemp
  ...
  parameter Modelica.Units.SI.Power QDesignLossInfiltration = 15455.542060901256 "Total design heat loss through air infiltration";
  parameter Modelica.Units.SI.HeatCapacity C = 801448891.4888967 "Total wall/floor/ceiling thermal mass. Includes parts exterior to insulation.";
  ...
  input Real u(start=0,min=0,max=0) "Dummy variable";
  ...
  output Modelica.Units.NonSI.Temperature_degC TRet_circulationPumpDp__Pump_BEO = Modelica.Units.Conversions.to_degC(circulationPumpDp__Pump_BEO.TRet) "";
  output Modelica.Units.NonSI.Temperature_degC TRet_circulationPumpDp__Pump_DH = Modelica.Units.Conversions.to_degC(circulationPumpDp__Pump_DH.TRet) "";
  output Modelica.Units.NonSI.Temperature_degC TRet_circulationPumpDp__Pump_HP = Modelica.Units.Conversions.to_degC(circulationPumpDp__Pump_HP.TRet) "";
  ...
  output Modelica.Units.NonSI.Temperature_degC TSup_circulationPumpDp__Pump_BEO = Modelica.Units.Conversions.to_degC(circulationPumpDp__Pump_BEO.TSup) "";
  output Modelica.Units.NonSI.Temperature_degC TSup_circulationPumpDp__Pump_DH = Modelica.Units.Conversions.to_degC(circulationPumpDp__Pump_DH.TSup) "";
  output Modelica.Units.NonSI.Temperature_degC TSup_circulationPumpDp__Pump_HP = Modelica.Units.Conversions.to_degC(circulationPumpDp__Pump_HP.TSup) "";
  ...
  output Modelica.Units.NonSI.Temperature_degC T_tank__Tank_HP = Modelica.Units.Conversions.to_degC(tank__Tank_HP.vol.heatPort.T) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__136_badkamer = Modelica.Units.Conversions.to_degC(zone__136_badkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__136_keuken = Modelica.Units.Conversions.to_degC(zone__136_keuken.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__136_slaapkamer = Modelica.Units.Conversions.to_degC(zone__136_slaapkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__136_toilet = Modelica.Units.Conversions.to_degC(zone__136_toilet.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__136_woonruimte = Modelica.Units.Conversions.to_degC(zone__136_woonruimte.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__138_badkamer = Modelica.Units.Conversions.to_degC(zone__138_badkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__138_keuken = Modelica.Units.Conversions.to_degC(zone__138_keuken.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__138_slaapkamer = Modelica.Units.Conversions.to_degC(zone__138_slaapkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__138_toilet = Modelica.Units.Conversions.to_degC(zone__138_toilet.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__138_woonruimte = Modelica.Units.Conversions.to_degC(zone__138_woonruimte.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__140_badkamer = Modelica.Units.Conversions.to_degC(zone__140_badkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__140_keuken = Modelica.Units.Conversions.to_degC(zone__140_keuken.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__140_slaapkamer = Modelica.Units.Conversions.to_degC(zone__140_slaapkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__140_toilet = Modelica.Units.Conversions.to_degC(zone__140_toilet.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__140_woonruimte = Modelica.Units.Conversions.to_degC(zone__140_woonruimte.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__142_badkamer = Modelica.Units.Conversions.to_degC(zone__142_badkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__142_keuken = Modelica.Units.Conversions.to_degC(zone__142_keuken.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__142_slaapkamer = Modelica.Units.Conversions.to_degC(zone__142_slaapkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__142_toilet = Modelica.Units.Conversions.to_degC(zone__142_toilet.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__142_woonruimte = Modelica.Units.Conversions.to_degC(zone__142_woonruimte.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__144_badkamer = Modelica.Units.Conversions.to_degC(zone__144_badkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__144_keuken = Modelica.Units.Conversions.to_degC(zone__144_keuken.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__144_slaapkamer = Modelica.Units.Conversions.to_degC(zone__144_slaapkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__144_toilet = Modelica.Units.Conversions.to_degC(zone__144_toilet.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__144_woonruimte = Modelica.Units.Conversions.to_degC(zone__144_woonruimte.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__146_badkamer = Modelica.Units.Conversions.to_degC(zone__146_badkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__146_keuken = Modelica.Units.Conversions.to_degC(zone__146_keuken.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__146_slaapkamer = Modelica.Units.Conversions.to_degC(zone__146_slaapkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__146_toilet = Modelica.Units.Conversions.to_degC(zone__146_toilet.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__146_woonruimte = Modelica.Units.Conversions.to_degC(zone__146_woonruimte.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__148_badkamer = Modelica.Units.Conversions.to_degC(zone__148_badkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__148_keuken = Modelica.Units.Conversions.to_degC(zone__148_keuken.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__148_slaapkamer = Modelica.Units.Conversions.to_degC(zone__148_slaapkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__148_toilet = Modelica.Units.Conversions.to_degC(zone__148_toilet.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__148_woonruimte = Modelica.Units.Conversions.to_degC(zone__148_woonruimte.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__150_badkamer = Modelica.Units.Conversions.to_degC(zone__150_badkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__150_keuken = Modelica.Units.Conversions.to_degC(zone__150_keuken.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__150_slaapkamer = Modelica.Units.Conversions.to_degC(zone__150_slaapkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__150_toilet = Modelica.Units.Conversions.to_degC(zone__150_toilet.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__150_woonruimte = Modelica.Units.Conversions.to_degC(zone__150_woonruimte.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__152_badkamer = Modelica.Units.Conversions.to_degC(zone__152_badkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__152_keuken = Modelica.Units.Conversions.to_degC(zone__152_keuken.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__152_slaapkamer = Modelica.Units.Conversions.to_degC(zone__152_slaapkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__152_toilet = Modelica.Units.Conversions.to_degC(zone__152_toilet.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__152_woonruimte = Modelica.Units.Conversions.to_degC(zone__152_woonruimte.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__154_badkamer = Modelica.Units.Conversions.to_degC(zone__154_badkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__154_keuken = Modelica.Units.Conversions.to_degC(zone__154_keuken.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__154_slaapkamer = Modelica.Units.Conversions.to_degC(zone__154_slaapkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__154_toilet = Modelica.Units.Conversions.to_degC(zone__154_toilet.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__154_woonruimte = Modelica.Units.Conversions.to_degC(zone__154_woonruimte.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__156_badkamer = Modelica.Units.Conversions.to_degC(zone__156_badkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__156_keuken = Modelica.Units.Conversions.to_degC(zone__156_keuken.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__156_slaapkamer = Modelica.Units.Conversions.to_degC(zone__156_slaapkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__156_toilet = Modelica.Units.Conversions.to_degC(zone__156_toilet.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__156_woonruimte = Modelica.Units.Conversions.to_degC(zone__156_woonruimte.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__158_badkamer = Modelica.Units.Conversions.to_degC(zone__158_badkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__158_keuken = Modelica.Units.Conversions.to_degC(zone__158_keuken.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__158_slaapkamer = Modelica.Units.Conversions.to_degC(zone__158_slaapkamer.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__158_toilet = Modelica.Units.Conversions.to_degC(zone__158_toilet.comfort.TComf) "";
  output Modelica.Units.NonSI.Temperature_degC T_zone__158_woonruimte = Modelica.Units.Conversions.to_degC(zone__158_woonruimte.comfort.TComf) "";
  ...
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_136 = pressurizer__Pressurizer_136.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_136.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_138 = pressurizer__Pressurizer_138.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_138.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_140 = pressurizer__Pressurizer_140.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_140.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_142 = pressurizer__Pressurizer_142.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_142.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_144 = pressurizer__Pressurizer_144.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_144.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_146 = pressurizer__Pressurizer_146.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_146.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_148 = pressurizer__Pressurizer_148.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_148.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_150 = pressurizer__Pressurizer_150.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_150.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_152 = pressurizer__Pressurizer_152.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_152.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_154 = pressurizer__Pressurizer_154.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_154.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_156 = pressurizer__Pressurizer_156.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_156.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_158 = pressurizer__Pressurizer_158.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_158.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_BEO = pressurizer__Pressurizer_BEO.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_BEO.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate dm_flow_pressurizer__Pressurizer_DH = pressurizer__Pressurizer_DH.absolutePressure.port_a.m_flow + pressurizer__Pressurizer_DH.absolutePressure.port_b.m_flow "Should equal zero";
  output Modelica.Units.SI.MassFlowRate m_flow_circuit1_tank__Tank_HP = tank__Tank_HP.port_a1.m_flow "";
  output Modelica.Units.SI.MassFlowRate m_flow_circuit2_tank__Tank_HP = tank__Tank_HP.port_a2.m_flow "";
  output Modelica.Units.SI.MassFlowRate m_flow_circuit3_tank__Tank_HP = tank__Tank_HP.port_a3.m_flow "";
  output Modelica.Units.SI.MassFlowRate m_flow_circuit4_tank__Tank_HP = tank__Tank_HP.port_a4.m_flow "";
  output Modelica.Units.SI.MassFlowRate m_flow_circuit5_tank__Tank_HP = tank__Tank_HP.port_a5.m_flow "";
  ...
  output Modelica.Units.SI.MassFlowRate m_flow_circulationPumpDp__Pump_BEO = circulationPumpDp__Pump_BEO.pump.m_flow "Pump mass flow rate";
  output Modelica.Units.SI.MassFlowRate m_flow_circulationPumpDp__Pump_DH = circulationPumpDp__Pump_DH.pump.m_flow "Pump mass flow rate";
  output Modelica.Units.SI.MassFlowRate m_flow_circulationPumpDp__Pump_HP = circulationPumpDp__Pump_HP.pump.m_flow "Pump mass flow rate";
...
//   output Modelica.Units.SI.Power QOcc_zone__158_woonruimte = -zone__158_woonruimte.intGaiOcc.portCon.Q_flow - zone__158_woonruimte.intGaiOcc.portRad.Q_flow "Sensible heat gains from occupants";
  ...
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__136_slaapkamer__CAVs_type_bedroom(displayUnit="m3/h") = supplyCav_zone__136_slaapkamer__CAVs_type_bedroom.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__136_woonruimte__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__136_woonruimte__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__138_slaapkamer__CAVs_type_bedroom(displayUnit="m3/h") = supplyCav_zone__138_slaapkamer__CAVs_type_bedroom.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__138_woonruimte__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__138_woonruimte__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__140_slaapkamer__CAVs_type_bedroom(displayUnit="m3/h") = supplyCav_zone__140_slaapkamer__CAVs_type_bedroom.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__140_woonruimte__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__140_woonruimte__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__142_slaapkamer__CAVs_type_bedroom(displayUnit="m3/h") = supplyCav_zone__142_slaapkamer__CAVs_type_bedroom.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__142_woonruimte__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__142_woonruimte__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__144_slaapkamer__CAVs_type_bedroom(displayUnit="m3/h") = supplyCav_zone__144_slaapkamer__CAVs_type_bedroom.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__144_woonruimte__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__144_woonruimte__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__146_slaapkamer__CAVs_type_bedroom(displayUnit="m3/h") = supplyCav_zone__146_slaapkamer__CAVs_type_bedroom.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__146_woonruimte__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__146_woonruimte__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__148_slaapkamer__CAVs_type_bedroom(displayUnit="m3/h") = supplyCav_zone__148_slaapkamer__CAVs_type_bedroom.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__148_woonruimte__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__148_woonruimte__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__150_slaapkamer__CAVs_type_bedroom(displayUnit="m3/h") = supplyCav_zone__150_slaapkamer__CAVs_type_bedroom.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__150_woonruimte__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__150_woonruimte__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__152_slaapkamer__CAVs_type_bedroom(displayUnit="m3/h") = supplyCav_zone__152_slaapkamer__CAVs_type_bedroom.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__152_woonruimte__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__152_woonruimte__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__154_slaapkamer__CAVs_type_bedroom(displayUnit="m3/h") = supplyCav_zone__154_slaapkamer__CAVs_type_bedroom.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__154_woonruimte__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__154_woonruimte__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__156_slaapkamer__CAVs_type_bedroom(displayUnit="m3/h") = supplyCav_zone__156_slaapkamer__CAVs_type_bedroom.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__156_woonruimte__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__156_woonruimte__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__158_slaapkamer__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__158_slaapkamer__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  output Modelica.Units.SI.VolumeFlowRate V_flow_supplyCav_zone__158_woonruimte__CAVs_type_living(displayUnit="m3/h") = supplyCav_zone__158_woonruimte__CAVs_type_living.port_a.m_flow/1.2*3600 "";
  ...
  output Real HGloE = sim.weaBus.solBus[5].HDirTil + sim.radSol[5].HDifTil.HGroDifTil + sim.radSol[5].HDifTil.HSkyDifTil "Total solar irradiation on the east (including offset) oriented surface";
  ...
  output Real HGloN = sim.weaBus.solBus[4].HDirTil + sim.radSol[4].HDifTil.HGroDifTil + sim.radSol[4].HDifTil.HSkyDifTil "Total solar irradiation on the north (including offset) oriented surface";
  output Real HGloS = sim.weaBus.solBus[2].HDirTil + sim.radSol[2].HDifTil.HGroDifTil + sim.radSol[2].HDifTil.HSkyDifTil "Total solar irradiation on the south (including offset) oriented surface";
  output Real HGloW = sim.weaBus.solBus[3].HDirTil + sim.radSol[3].HDifTil.HGroDifTil + sim.radSol[3].HDifTil.HSkyDifTil "Total solar irradiation on the west (including offset) oriented surface";
...
//   output Real HSha_window__Window_toilet__9 = window__Window_toilet__9.shaType.HSha "Total solar irradiance through 'window__Window_toilet__9'";
  ...
  output Real Q_flow_energyMeter__Energy_meter_BEO = borefield__BEO.port_a.m_flow*(borefield__BEO.port_b.h_outflow - inStream(borefield__BEO.port_a.h_outflow)) "";
  output Real Q_flow_energyMeter__Energy_meter_DH = circulationPumpDp__Pump_DH.port_a2.m_flow*(circulationPumpDp__Pump_DH.port_b2.h_outflow - inStream(circulationPumpDp__Pump_DH.port_a2.h_outflow)) "";
  output Real Q_flow_energyMeter__Energy_meter_tank = heatPump__HP_BW45.port_a2.m_flow*(heatPump__HP_BW45.port_b2.h_outflow - inStream(heatPump__HP_BW45.port_a2.h_outflow)) "";
  output Real RH = sim.XiEnv.phi "Outdoor relative humidity";
  output Real Xw = sim.XiEnv.X[1] "Outdoor absolute humidity";
  output Real dpRet_airHandlingUnit__AHU_136 = airHandlingUnit__AHU_136.dpRet "";
  output Real dpRet_airHandlingUnit__AHU_138 = airHandlingUnit__AHU_138.dpRet "";
  output Real dpRet_airHandlingUnit__AHU_140 = airHandlingUnit__AHU_140.dpRet "";
  output Real dpRet_airHandlingUnit__AHU_142 = airHandlingUnit__AHU_142.dpRet "";
  output Real dpRet_airHandlingUnit__AHU_144 = airHandlingUnit__AHU_144.dpRet "";
  output Real dpRet_airHandlingUnit__AHU_146 = airHandlingUnit__AHU_146.dpRet "";
  output Real dpRet_airHandlingUnit__AHU_148 = airHandlingUnit__AHU_148.dpRet "";
  output Real dpRet_airHandlingUnit__AHU_150 = airHandlingUnit__AHU_150.dpRet "";
  output Real dpRet_airHandlingUnit__AHU_152 = airHandlingUnit__AHU_152.dpRet "";
  output Real dpRet_airHandlingUnit__AHU_154 = airHandlingUnit__AHU_154.dpRet "";
  output Real dpRet_airHandlingUnit__AHU_156 = airHandlingUnit__AHU_156.dpRet "";
  output Real dpRet_airHandlingUnit__AHU_158 = airHandlingUnit__AHU_158.dpRet "";
  output Real dpSup_airHandlingUnit__AHU_136 = airHandlingUnit__AHU_136.dpSup "";
  output Real dpSup_airHandlingUnit__AHU_138 = airHandlingUnit__AHU_138.dpSup "";
  output Real dpSup_airHandlingUnit__AHU_140 = airHandlingUnit__AHU_140.dpSup "";
  output Real dpSup_airHandlingUnit__AHU_142 = airHandlingUnit__AHU_142.dpSup "";
  output Real dpSup_airHandlingUnit__AHU_144 = airHandlingUnit__AHU_144.dpSup "";
  output Real dpSup_airHandlingUnit__AHU_146 = airHandlingUnit__AHU_146.dpSup "";
  output Real dpSup_airHandlingUnit__AHU_148 = airHandlingUnit__AHU_148.dpSup "";
  output Real dpSup_airHandlingUnit__AHU_150 = airHandlingUnit__AHU_150.dpSup "";
  output Real dpSup_airHandlingUnit__AHU_152 = airHandlingUnit__AHU_152.dpSup "";
  output Real dpSup_airHandlingUnit__AHU_154 = airHandlingUnit__AHU_154.dpSup "";
  output Real dpSup_airHandlingUnit__AHU_156 = airHandlingUnit__AHU_156.dpSup "";
  output Real dpSup_airHandlingUnit__AHU_158 = airHandlingUnit__AHU_158.dpSup "";
//   output Real etaRet_airHandlingUnit__AHU_136 = airHandlingUnit__AHU_136.fanRet.eta "";
//   output Real etaRet_airHandlingUnit__AHU_138 = airHandlingUnit__AHU_138.fanRet.eta "";
//   output Real etaRet_airHandlingUnit__AHU_140 = airHandlingUnit__AHU_140.fanRet.eta "";
//   output Real etaRet_airHandlingUnit__AHU_142 = airHandlingUnit__AHU_142.fanRet.eta "";
//   output Real etaRet_airHandlingUnit__AHU_144 = airHandlingUnit__AHU_144.fanRet.eta "";
//   output Real etaRet_airHandlingUnit__AHU_146 = airHandlingUnit__AHU_146.fanRet.eta "";
//   output Real etaRet_airHandlingUnit__AHU_148 = airHandlingUnit__AHU_148.fanRet.eta "";
//   output Real etaRet_airHandlingUnit__AHU_150 = airHandlingUnit__AHU_150.fanRet.eta "";
//   output Real etaRet_airHandlingUnit__AHU_152 = airHandlingUnit__AHU_152.fanRet.eta "";
//   output Real etaRet_airHandlingUnit__AHU_154 = airHandlingUnit__AHU_154.fanRet.eta "";
//   output Real etaRet_airHandlingUnit__AHU_156 = airHandlingUnit__AHU_156.fanRet.eta "";
//   output Real etaRet_airHandlingUnit__AHU_158 = airHandlingUnit__AHU_158.fanRet.eta "";
//   output Real etaSup_airHandlingUnit__AHU_136 = airHandlingUnit__AHU_136.fanSup.eta "";
//   output Real etaSup_airHandlingUnit__AHU_138 = airHandlingUnit__AHU_138.fanSup.eta "";
//   output Real etaSup_airHandlingUnit__AHU_140 = airHandlingUnit__AHU_140.fanSup.eta "";
//   output Real etaSup_airHandlingUnit__AHU_142 = airHandlingUnit__AHU_142.fanSup.eta "";
//   output Real etaSup_airHandlingUnit__AHU_144 = airHandlingUnit__AHU_144.fanSup.eta "";
//   output Real etaSup_airHandlingUnit__AHU_146 = airHandlingUnit__AHU_146.fanSup.eta "";
//   output Real etaSup_airHandlingUnit__AHU_148 = airHandlingUnit__AHU_148.fanSup.eta "";
//   output Real etaSup_airHandlingUnit__AHU_150 = airHandlingUnit__AHU_150.fanSup.eta "";
//   output Real etaSup_airHandlingUnit__AHU_152 = airHandlingUnit__AHU_152.fanSup.eta "";
//   output Real etaSup_airHandlingUnit__AHU_154 = airHandlingUnit__AHU_154.fanSup.eta "";
//   output Real etaSup_airHandlingUnit__AHU_156 = airHandlingUnit__AHU_156.fanSup.eta "";
//   output Real etaSup_airHandlingUnit__AHU_158 = airHandlingUnit__AHU_158.fanSup.eta "";
  ...
  output Real m_flow_energyMeter__Energy_meter_BEO = borefield__BEO.port_a.m_flow "";
  output Real m_flow_energyMeter__Energy_meter_DH = circulationPumpDp__Pump_DH.port_a2.m_flow "";
  output Real m_flow_energyMeter__Energy_meter_tank = heatPump__HP_BW45.port_a2.m_flow "";
  output Real objInt = pEl_Schema_DeSchipjes;
  output Real obj__PEl_heatPump__HP_BW45 = heatPump__HP_BW45.PEl "";
  ...
  output Real obj__P_circulationPumpDp__Pump_BEO = circulationPumpDp__Pump_BEO.P "";
  output Real obj__P_circulationPumpDp__Pump_DH = circulationPumpDp__Pump_DH.P "";
  output Real obj__P_circulationPumpDp__Pump_HP = circulationPumpDp__Pump_HP.P "";
  ...
  output Real TSetHea = 21;
  output Real DiscmfHea_zone__136_badkamer = max(0, TSetHea - T_zone__136_badkamer);
  output Real DiscmfHea_zone__136_keuken = max(0, TSetHea - T_zone__136_keuken);
  output Real DiscmfHea_zone__136_slaapkamer = max(0, TSetHea - T_zone__136_slaapkamer);
  output Real DiscmfHea_zone__136_toilet = max(0, TSetHea - T_zone__136_toilet);
  output Real DiscmfHea_zone__136_woonruimte = max(0, TSetHea - T_zone__136_woonruimte);
  output Real DiscmfHea_zone__138_badkamer = max(0, TSetHea - T_zone__138_badkamer);
  output Real DiscmfHea_zone__138_keuken = max(0, TSetHea - T_zone__138_keuken);
  output Real DiscmfHea_zone__138_slaapkamer = max(0, TSetHea - T_zone__138_slaapkamer);
  output Real DiscmfHea_zone__138_toilet = max(0, TSetHea - T_zone__138_toilet);
  output Real DiscmfHea_zone__138_woonruimte = max(0, TSetHea - T_zone__138_woonruimte);
  output Real DiscmfHea_zone__140_badkamer = max(0, TSetHea - T_zone__140_badkamer);
  output Real DiscmfHea_zone__140_keuken = max(0, TSetHea - T_zone__140_keuken);
  output Real DiscmfHea_zone__140_slaapkamer = max(0, TSetHea - T_zone__140_slaapkamer);
  output Real DiscmfHea_zone__140_toilet = max(0, TSetHea - T_zone__140_toilet);
  output Real DiscmfHea_zone__140_woonruimte = max(0, TSetHea - T_zone__140_woonruimte);
  output Real DiscmfHea_zone__142_badkamer = max(0, TSetHea - T_zone__142_badkamer);
  output Real DiscmfHea_zone__142_keuken = max(0, TSetHea - T_zone__142_keuken);
  output Real DiscmfHea_zone__142_slaapkamer = max(0, TSetHea - T_zone__142_slaapkamer);
  output Real DiscmfHea_zone__142_toilet = max(0, TSetHea - T_zone__142_toilet);
  output Real DiscmfHea_zone__142_woonruimte = max(0, TSetHea - T_zone__142_woonruimte);
  output Real DiscmfHea_zone__144_badkamer = max(0, TSetHea - T_zone__144_badkamer);
  output Real DiscmfHea_zone__144_keuken = max(0, TSetHea - T_zone__144_keuken);
  output Real DiscmfHea_zone__144_slaapkamer = max(0, TSetHea - T_zone__144_slaapkamer);
  output Real DiscmfHea_zone__144_toilet = max(0, TSetHea - T_zone__144_toilet);
  output Real DiscmfHea_zone__144_woonruimte = max(0, TSetHea - T_zone__144_woonruimte);
  output Real DiscmfHea_zone__146_badkamer = max(0, TSetHea - T_zone__146_badkamer);
  output Real DiscmfHea_zone__146_keuken = max(0, TSetHea - T_zone__146_keuken);
  output Real DiscmfHea_zone__146_slaapkamer = max(0, TSetHea - T_zone__146_slaapkamer);
  output Real DiscmfHea_zone__146_toilet = max(0, TSetHea - T_zone__146_toilet);
  output Real DiscmfHea_zone__146_woonruimte = max(0, TSetHea - T_zone__146_woonruimte);
  output Real DiscmfHea_zone__148_badkamer = max(0, TSetHea - T_zone__148_badkamer);
  output Real DiscmfHea_zone__148_keuken = max(0, TSetHea - T_zone__148_keuken);
  output Real DiscmfHea_zone__148_slaapkamer = max(0, TSetHea - T_zone__148_slaapkamer);
  output Real DiscmfHea_zone__148_toilet = max(0, TSetHea - T_zone__148_toilet);
  output Real DiscmfHea_zone__148_woonruimte = max(0, TSetHea - T_zone__148_woonruimte);
  output Real DiscmfHea_zone__150_badkamer = max(0, TSetHea - T_zone__150_badkamer);
  output Real DiscmfHea_zone__150_keuken = max(0, TSetHea - T_zone__150_keuken);
  output Real DiscmfHea_zone__150_slaapkamer = max(0, TSetHea - T_zone__150_slaapkamer);
  output Real DiscmfHea_zone__150_toilet = max(0, TSetHea - T_zone__150_toilet);
  output Real DiscmfHea_zone__150_woonruimte = max(0, TSetHea - T_zone__150_woonruimte);
  output Real DiscmfHea_zone__152_badkamer = max(0, TSetHea - T_zone__152_badkamer);
  output Real DiscmfHea_zone__152_keuken = max(0, TSetHea - T_zone__152_keuken);
  output Real DiscmfHea_zone__152_slaapkamer = max(0, TSetHea - T_zone__152_slaapkamer);
  output Real DiscmfHea_zone__152_toilet = max(0, TSetHea - T_zone__152_toilet);
  output Real DiscmfHea_zone__152_woonruimte = max(0, TSetHea - T_zone__152_woonruimte);
  output Real DiscmfHea_zone__154_badkamer = max(0, TSetHea - T_zone__154_badkamer);
  output Real DiscmfHea_zone__154_keuken = max(0, TSetHea - T_zone__154_keuken);
  output Real DiscmfHea_zone__154_slaapkamer = max(0, TSetHea - T_zone__154_slaapkamer);
  output Real DiscmfHea_zone__154_toilet = max(0, TSetHea - T_zone__154_toilet);
  output Real DiscmfHea_zone__154_woonruimte = max(0, TSetHea - T_zone__154_woonruimte);
  output Real DiscmfHea_zone__156_badkamer = max(0, TSetHea - T_zone__156_badkamer);
  output Real DiscmfHea_zone__156_keuken = max(0, TSetHea - T_zone__156_keuken);
  output Real DiscmfHea_zone__156_slaapkamer = max(0, TSetHea - T_zone__156_slaapkamer);
  output Real DiscmfHea_zone__156_toilet = max(0, TSetHea - T_zone__156_toilet);
  output Real DiscmfHea_zone__156_woonruimte = max(0, TSetHea - T_zone__156_woonruimte);
  output Real DiscmfHea_zone__158_badkamer = max(0, TSetHea - T_zone__158_badkamer);
  output Real DiscmfHea_zone__158_keuken = max(0, TSetHea - T_zone__158_keuken);
  output Real DiscmfHea_zone__158_slaapkamer = max(0, TSetHea - T_zone__158_slaapkamer);
  output Real DiscmfHea_zone__158_toilet = max(0, TSetHea - T_zone__158_toilet);
  output Real DiscmfHea_zone__158_woonruimte = max(0, TSetHea - T_zone__158_woonruimte);
  output Real DiscmfHea =    DiscmfHea_zone__136_badkamer +
         DiscmfHea_zone__136_keuken +
         DiscmfHea_zone__136_slaapkamer +
         DiscmfHea_zone__136_toilet +
         DiscmfHea_zone__136_woonruimte +
         DiscmfHea_zone__138_badkamer +
         DiscmfHea_zone__138_keuken +
         DiscmfHea_zone__138_slaapkamer +
         DiscmfHea_zone__138_toilet +
         DiscmfHea_zone__138_woonruimte +
         DiscmfHea_zone__140_badkamer +
         DiscmfHea_zone__140_keuken +
         DiscmfHea_zone__140_slaapkamer +
         DiscmfHea_zone__140_toilet +
         DiscmfHea_zone__140_woonruimte +
         DiscmfHea_zone__142_badkamer +
         DiscmfHea_zone__142_keuken +
         DiscmfHea_zone__142_slaapkamer +
         DiscmfHea_zone__142_toilet +
         DiscmfHea_zone__142_woonruimte +
         DiscmfHea_zone__144_badkamer +
         DiscmfHea_zone__144_keuken +
         DiscmfHea_zone__144_slaapkamer +
         DiscmfHea_zone__144_toilet +
         DiscmfHea_zone__144_woonruimte +
         DiscmfHea_zone__146_badkamer +
         DiscmfHea_zone__146_keuken +
         DiscmfHea_zone__146_slaapkamer +
         DiscmfHea_zone__146_toilet +
         DiscmfHea_zone__146_woonruimte +
         DiscmfHea_zone__148_badkamer +
         DiscmfHea_zone__148_keuken +
         DiscmfHea_zone__148_slaapkamer +
         DiscmfHea_zone__148_toilet +
         DiscmfHea_zone__148_woonruimte +
         DiscmfHea_zone__150_badkamer +
         DiscmfHea_zone__150_keuken +
         DiscmfHea_zone__150_slaapkamer +
         DiscmfHea_zone__150_toilet +
         DiscmfHea_zone__150_woonruimte +
         DiscmfHea_zone__152_badkamer +
         DiscmfHea_zone__152_keuken +
         DiscmfHea_zone__152_slaapkamer +
         DiscmfHea_zone__152_toilet +
         DiscmfHea_zone__152_woonruimte +
         DiscmfHea_zone__154_badkamer +
         DiscmfHea_zone__154_keuken +
         DiscmfHea_zone__154_slaapkamer +
         DiscmfHea_zone__154_toilet +
         DiscmfHea_zone__154_woonruimte +
         DiscmfHea_zone__156_badkamer +
         DiscmfHea_zone__156_keuken +
         DiscmfHea_zone__156_slaapkamer +
         DiscmfHea_zone__156_toilet +
         DiscmfHea_zone__156_woonruimte +
         DiscmfHea_zone__158_badkamer +
         DiscmfHea_zone__158_keuken +
         DiscmfHea_zone__158_slaapkamer +
         DiscmfHea_zone__158_toilet +
         DiscmfHea_zone__158_woonruimte;
     output Real ObjIntComfSHea = DiscmfHea_zone__136_badkamer^2 +
         DiscmfHea_zone__136_keuken^2 +
         DiscmfHea_zone__136_slaapkamer^2 +
         DiscmfHea_zone__136_toilet^2 +
         DiscmfHea_zone__136_woonruimte^2 +
         DiscmfHea_zone__138_badkamer^2 +
         DiscmfHea_zone__138_keuken^2 +
         DiscmfHea_zone__138_slaapkamer^2 +
         DiscmfHea_zone__138_toilet^2 +
         DiscmfHea_zone__138_woonruimte^2 +
         DiscmfHea_zone__140_badkamer^2 +
         DiscmfHea_zone__140_keuken^2 +
         DiscmfHea_zone__140_slaapkamer^2 +
         DiscmfHea_zone__140_toilet^2 +
         DiscmfHea_zone__140_woonruimte^2 +
         DiscmfHea_zone__142_badkamer^2 +
         DiscmfHea_zone__142_keuken^2 +
         DiscmfHea_zone__142_slaapkamer^2 +
         DiscmfHea_zone__142_toilet^2 +
         DiscmfHea_zone__142_woonruimte^2 +
         DiscmfHea_zone__144_badkamer^2 +
         DiscmfHea_zone__144_keuken^2 +
         DiscmfHea_zone__144_slaapkamer^2 +
         DiscmfHea_zone__144_toilet^2 +
         DiscmfHea_zone__144_woonruimte^2 +
         DiscmfHea_zone__146_badkamer^2 +
         DiscmfHea_zone__146_keuken^2 +
         DiscmfHea_zone__146_slaapkamer^2 +
         DiscmfHea_zone__146_toilet^2 +
         DiscmfHea_zone__146_woonruimte^2 +
         DiscmfHea_zone__148_badkamer^2 +
         DiscmfHea_zone__148_keuken^2 +
         DiscmfHea_zone__148_slaapkamer^2 +
         DiscmfHea_zone__148_toilet^2 +
         DiscmfHea_zone__148_woonruimte^2 +
         DiscmfHea_zone__150_badkamer^2 +
         DiscmfHea_zone__150_keuken^2 +
         DiscmfHea_zone__150_slaapkamer^2 +
         DiscmfHea_zone__150_toilet^2 +
         DiscmfHea_zone__150_woonruimte^2 +
         DiscmfHea_zone__152_badkamer^2 +
         DiscmfHea_zone__152_keuken^2 +
         DiscmfHea_zone__152_slaapkamer^2 +
         DiscmfHea_zone__152_toilet^2 +
         DiscmfHea_zone__152_woonruimte^2 +
         DiscmfHea_zone__154_badkamer^2 +
         DiscmfHea_zone__154_keuken^2 +
         DiscmfHea_zone__154_slaapkamer^2 +
         DiscmfHea_zone__154_toilet^2 +
         DiscmfHea_zone__154_woonruimte^2 +
         DiscmfHea_zone__156_badkamer^2 +
         DiscmfHea_zone__156_keuken^2 +
         DiscmfHea_zone__156_slaapkamer^2 +
         DiscmfHea_zone__156_toilet^2 +
         DiscmfHea_zone__156_woonruimte^2 +
         DiscmfHea_zone__158_badkamer^2 +
         DiscmfHea_zone__158_keuken^2 +
         DiscmfHea_zone__158_slaapkamer^2 +
         DiscmfHea_zone__158_toilet^2 +
         DiscmfHea_zone__158_woonruimte^2;
...
//   output Real ppm_zone__158_woonruimte = zone__158_woonruimte.ppm "";
  ...
  parameter Real multiplier_occ_zone_136_slaapkamer(fixed=false, start=1); // reads value from field multiplier_occ_zone_136_slaapkamer
  parameter Real multiplier_occ_zone_136_woonruimte(fixed=false, start=1); // reads value from field multiplier_occ_zone_136_woonruimte
  parameter Real multiplier_occ_zone_138_slaapkamer(fixed=false, start=1); // reads value from field multiplier_occ_zone_138_slaapkamer
  parameter Real multiplier_occ_zone_138_woonruimte(fixed=false, start=1); // reads value from field multiplier_occ_zone_138_woonruimte
  parameter Real multiplier_occ_zone_140_slaapkamer(fixed=false, start=1); // reads value from field multiplier_occ_zone_140_slaapkamer
  parameter Real multiplier_occ_zone_140_woonruimte(fixed=false, start=1); // reads value from field multiplier_occ_zone_140_woonruimte
  parameter Real multiplier_occ_zone_142_slaapkamer(fixed=false, start=1); // reads value from field multiplier_occ_zone_142_slaapkamer
  parameter Real multiplier_occ_zone_142_woonruimte(fixed=false, start=1); // reads value from field multiplier_occ_zone_142_woonruimte
  parameter Real multiplier_occ_zone_144_slaapkamer(fixed=false, start=1); // reads value from field multiplier_occ_zone_144_slaapkamer
  parameter Real multiplier_occ_zone_144_woonruimte(fixed=false, start=1); // reads value from field multiplier_occ_zone_144_woonruimte
  parameter Real multiplier_occ_zone_146_slaapkamer(fixed=false, start=1); // reads value from field multiplier_occ_zone_146_slaapkamer
  parameter Real multiplier_occ_zone_146_woonruimte(fixed=false, start=1); // reads value from field multiplier_occ_zone_146_woonruimte
  parameter Real multiplier_occ_zone_148_slaapkamer(fixed=false, start=1); // reads value from field multiplier_occ_zone_148_slaapkamer
  parameter Real multiplier_occ_zone_148_woonruimte(fixed=false, start=1); // reads value from field multiplier_occ_zone_148_woonruimte
  parameter Real multiplier_occ_zone_150_slaapkamer(fixed=false, start=1); // reads value from field multiplier_occ_zone_150_slaapkamer
  parameter Real multiplier_occ_zone_150_woonruimte(fixed=false, start=1); // reads value from field multiplier_occ_zone_150_woonruimte
  parameter Real multiplier_occ_zone_152_slaapkamer(fixed=false, start=1); // reads value from field multiplier_occ_zone_152_slaapkamer
  parameter Real multiplier_occ_zone_152_woonruimte(fixed=false, start=1); // reads value from field multiplier_occ_zone_152_woonruimte
  parameter Real multiplier_occ_zone_154_slaapkamer(fixed=false, start=1); // reads value from field multiplier_occ_zone_154_slaapkamer
  parameter Real multiplier_occ_zone_154_woonruimte(fixed=false, start=1); // reads value from field multiplier_occ_zone_154_woonruimte
  parameter Real multiplier_occ_zone_156_slaapkamer(fixed=false, start=1); // reads value from field multiplier_occ_zone_156_slaapkamer
  parameter Real multiplier_occ_zone_156_woonruimte(fixed=false, start=1); // reads value from field multiplier_occ_zone_156_woonruimte
  parameter Real multiplier_occ_zone_158_slaapkamer(fixed=false, start=1); // reads value from field multiplier_occ_zone_158_slaapkamer
  parameter Real multiplier_occ_zone_158_woonruimte(fixed=false, start=1); // reads value from field multiplier_occ_zone_158_woonruimte
  ...
  parameter Real weeklyProfile__Always_on_wednesday_on(fixed=false, start=0); // reads value from field weeklyProfile__Always_on_wednesday_on
    String WeeklyScheduleScheduletxt__1_loadResource=Modelica.Utilities.Files.loadResource("modelica://IOCSmod/Resources/OccupancyProfiles/Schedule_DeSchipjes.txt");
    IDEAS.Utilities.IO.Files.WeeklySchedule WeeklyScheduleScheduletxt__1(
      t_offset=1641168000 - timZon__1,
      fileName="Schedule_DeSchipjes.txt",
  ...
  IDEAS.Buildings.Components.Window window__Window_bedroom(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=6.274539896881408, dh=14.95, hWin=0.7),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.7, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
  ...
  IDEAS.Buildings.Components.Window window__Window_bedroom__10(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=11.792307692307693, dh=14.95, hWin=0.7),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.7, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_bedroom__11(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=56.58135815502307, dh=0.9500000000000002, hWin=0.7),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.7, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_bedroom__12(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=6.736000000000001, dh=0.9500000000000002, hWin=0.7),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.7, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_bedroom__13(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=6.571200000000005, dh=4.15, hWin=0.7),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.7, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_bedroom__2(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=6.515350316471228, dh=14.95, hWin=0.7),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.7, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_bedroom__3(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=6.485294100590456, dh=14.95, hWin=0.7),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.7, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_bedroom__4(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=6.611328894523758, dh=14.95, hWin=0.7),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.7, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_bedroom__5(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=46.98071585420859, dh=0.9500000000000002, hWin=0.7),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.7, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_bedroom__6(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=31.78663924858204, dh=0.9500000000000002, hWin=0.7),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.7, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_bedroom__9(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=11.433333333333332, dh=14.95, hWin=0.7),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.7, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_kitchen(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=9.08425626166787, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=1.4, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
    frac=0.1,
  ...
  IDEAS.Buildings.Components.Window window__Window_kitchen__10(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=18.611428571428572, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=1.4, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_kitchen__11(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=16.258974358974356, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=1.4, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_kitchen__3(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=9.779627044596944, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=1.4, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_kitchen__4(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=9.85928989430837, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=1.4, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_kitchen__6(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=16.86987589609762, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=1.4, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_kitchen__7(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=7.939900496896714, dh=3.7, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=1.4, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_kitchen__8(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=2.7714285714285714, dh=3.7, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=1.4, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_kitchen__9(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=15.142857142857146, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=1.4, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_2(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=18.86666666666667, dh=3.7, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
    frac=0.1,
  ...
  IDEAS.Buildings.Components.Window window__Window_living_2__2(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=11.307692307692308, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_2__3(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=11.541025641025639, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_2__4(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=45.96756756756757, dh=3.7, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_2__5(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=45.62499999999999, dh=3.7, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_2__6(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=44.117210430146436, dh=3.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_2__8(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=6.448031717635399, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_2__9(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=6.576902010522428, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_3(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=11.81025641025641, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_3__2(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=6.61945662920027, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_3__3(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=6.487740583770885, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_3__4(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=6.28474553282962, dh=17.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_3__5(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=5.462400000000002, dh=3.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_4(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=31.994477379889336, dh=3.5, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_living_4__2(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=25.402645101971633, dh=3.7, hWin=2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=2, wWin=0.55, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_toilet(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=7.729921361300599, dh=18.4, hWin=0.2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.2, wWin=0.2, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
    frac=0.1,
  ...
  IDEAS.Buildings.Components.Window window__Window_toilet__10(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=16.384615384615387, dh=18.4, hWin=0.2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.2, wWin=0.2, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_toilet__2(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=13.337536596169901, dh=18.4, hWin=0.2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.2, wWin=0.2, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_toilet__4(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=7.827406765605422, dh=18.4, hWin=0.2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.2, wWin=0.2, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_toilet__7(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=6.4, dh=4.6, hWin=0.2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.2, wWin=0.2, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_toilet__8(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=15.274285714285718, dh=18.4, hWin=0.2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.2, wWin=0.2, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  IDEAS.Buildings.Components.Window window__Window_toilet__9(
    redeclare IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading shaType(
      redeclare IDEAS.Buildings.Components.Shading.BuildingShade stateShading1(L=14.234285714285718, dh=18.4, hWin=0.2),
      redeclare IDEAS.Buildings.Components.Shading.Box stateShading2(hWin=0.2, wWin=0.2, wLeft=10, wRight=10, ovDep=0.2, ovGap=0, hFin=10, finDep=0.2, finGap=0)),
    redeclare package Medium=MediumAir,
    redeclare parameter glazingtype__Double_wo_coating glazing,
    redeclare IDEAS.Buildings.Data.Frames.Pvc fraType(U_value=1.5),
  ...
  UnitTests.Components.LosslessPipe floorHeating__VVW_136__supplyPipe(
    redeclare package Medium = MediumWater,
    m_flow_nominal=0.05190313061329231);
  UnitTests.Components.LosslessPipe floorHeating__VVW_138__supplyPipe(
    redeclare package Medium = MediumWater,
    m_flow_nominal=0.04910805976430976);
  UnitTests.Components.LosslessPipe floorHeating__VVW_140__supplyPipe(
    redeclare package Medium = MediumWater,
    m_flow_nominal=0.043305555555555555);
  UnitTests.Components.LosslessPipe floorHeating__VVW_142__supplyPipe(
    redeclare package Medium = MediumWater,
    m_flow_nominal=0.04707887751232461);
  UnitTests.Components.LosslessPipe floorHeating__VVW_144__supplyPipe(
    redeclare package Medium = MediumWater,
    m_flow_nominal=0.04702777777777778);
  UnitTests.Components.LosslessPipe floorHeating__VVW_146__supplyPipe(
    redeclare package Medium = MediumWater,
    m_flow_nominal=0.045984126984126975);
  UnitTests.Components.LosslessPipe floorHeating__VVW_148__supplyPipe(
    redeclare package Medium = MediumWater,
    m_flow_nominal=0.04636111111111112);
  UnitTests.Components.LosslessPipe floorHeating__VVW_150__supplyPipe(
    redeclare package Medium = MediumWater,
    m_flow_nominal=0.05217258728262313);
  UnitTests.Components.LosslessPipe floorHeating__VVW_152__supplyPipe(
    redeclare package Medium = MediumWater,
    m_flow_nominal=0.049);
  UnitTests.Components.LosslessPipe floorHeating__VVW_154__supplyPipe(
    redeclare package Medium = MediumWater,
    m_flow_nominal=0.04944444444444445);
  UnitTests.Components.LosslessPipe floorHeating__VVW_156__supplyPipe(
    redeclare package Medium = MediumWater,
    m_flow_nominal=0.04833333333333333);
  UnitTests.Components.LosslessPipe floorHeating__VVW_158__supplyPipe(
    redeclare package Medium = MediumWater,
  ...
  UnitTests.Confidential.SimpleAhu airHandlingUnit__AHU_136(
    fanRet(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_136.dp_fanSup),
       fanSup(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_136.dp_fanRet),
    use_on_in=true,
    redeclare package Medium=MediumAir,
    ...
    dp_fanRet=20,
    dp_fanSup=20,
    n_in=airHandlingUnit__AHU_136_n_in,
    n_out=airHandlingUnit__AHU_136_n_out,
    dp1_nominal=120,
    dp2_nominal=120,
    UA=236.11129999999997) annotation(Placement(transformation(extent={{1348.0,1018.0},{1368.0,1038.0}})));
  UnitTests.Confidential.SimpleAhu airHandlingUnit__AHU_138(
    fanRet(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_138.dp_fanSup),
       fanSup(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_138.dp_fanRet),
    use_on_in=true,
    redeclare package Medium=MediumAir,
    addDummyEquation=addDummyEquation,
    m1_flow_nominal=0.0416667,
    ...
    dp_fanRet=20,
    dp_fanSup=20,
    n_in=airHandlingUnit__AHU_138_n_in,
    n_out=airHandlingUnit__AHU_138_n_out,
    dp1_nominal=120,
    dp2_nominal=120,
    UA=236.11129999999997) annotation(Placement(transformation(extent={{1348.0,1068.0},{1368.0,1088.0}})));
  UnitTests.Confidential.SimpleAhu airHandlingUnit__AHU_140(
    fanRet(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_140.dp_fanSup),
       fanSup(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_140.dp_fanRet),
    use_on_in=true,
    redeclare package Medium=MediumAir,
    addDummyEquation=addDummyEquation,
    m1_flow_nominal=0.0416667,
    ...
    dp_fanRet=20,
    dp_fanSup=20,
    n_in=airHandlingUnit__AHU_140_n_in,
    n_out=airHandlingUnit__AHU_140_n_out,
    dp1_nominal=120,
    dp2_nominal=120,
    UA=236.11129999999997) annotation(Placement(transformation(extent={{1348.0,1118.0},{1368.0,1138.0}})));
  UnitTests.Confidential.SimpleAhu airHandlingUnit__AHU_142(
    fanRet(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_142.dp_fanSup),
       fanSup(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_142.dp_fanRet),
    use_on_in=true,
    redeclare package Medium=MediumAir,
    addDummyEquation=addDummyEquation,
    m1_flow_nominal=0.0416667,
    ...
    dp_fanRet=20,
    dp_fanSup=20,
    n_in=airHandlingUnit__AHU_142_n_in,
    n_out=airHandlingUnit__AHU_142_n_out,
    dp1_nominal=120,
    dp2_nominal=120,
    UA=236.11129999999997) annotation(Placement(transformation(extent={{1348.0,1168.0},{1368.0,1188.0}})));
  UnitTests.Confidential.SimpleAhu airHandlingUnit__AHU_144(
    fanRet(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_144.dp_fanSup),
       fanSup(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_144.dp_fanRet),
    use_on_in=true,
    redeclare package Medium=MediumAir,
    addDummyEquation=addDummyEquation,
    m1_flow_nominal=0.0416667,
    ...
    dp_fanRet=20,
    dp_fanSup=20,
    n_in=airHandlingUnit__AHU_144_n_in,
    n_out=airHandlingUnit__AHU_144_n_out,
    dp1_nominal=120,
    dp2_nominal=120,
    UA=236.11129999999997) annotation(Placement(transformation(extent={{1348.0,1218.0},{1368.0,1238.0}})));
  UnitTests.Confidential.SimpleAhu airHandlingUnit__AHU_146(
    fanRet(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_146.dp_fanSup),
       fanSup(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_146.dp_fanRet),
    use_on_in=true,
    redeclare package Medium=MediumAir,
    addDummyEquation=addDummyEquation,
    m1_flow_nominal=0.0416667,
    ...
    dp_fanRet=20,
    dp_fanSup=20,
    n_in=airHandlingUnit__AHU_146_n_in,
    n_out=airHandlingUnit__AHU_146_n_out,
    dp1_nominal=120,
    dp2_nominal=120,
    UA=236.11129999999997) annotation(Placement(transformation(extent={{1348.0,1268.0},{1368.0,1288.0}})));
  UnitTests.Confidential.SimpleAhu airHandlingUnit__AHU_148(
    fanRet(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_148.dp_fanSup),
       fanSup(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_148.dp_fanRet),
    use_on_in=true,
    redeclare package Medium=MediumAir,
    addDummyEquation=addDummyEquation,
    m1_flow_nominal=0.0416667,
    ...
    dp_fanRet=20,
    dp_fanSup=20,
    n_in=airHandlingUnit__AHU_148_n_in,
    n_out=airHandlingUnit__AHU_148_n_out,
    dp1_nominal=120,
    dp2_nominal=120,
    UA=236.11129999999997) annotation(Placement(transformation(extent={{1348.0,1318.0},{1368.0,1338.0}})));
  UnitTests.Confidential.SimpleAhu airHandlingUnit__AHU_150(
    fanRet(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_150.dp_fanSup),
       fanSup(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_150.dp_fanRet),
    use_on_in=true,
    redeclare package Medium=MediumAir,
    addDummyEquation=addDummyEquation,
    m1_flow_nominal=0.0416667,
    ...
    dp_fanRet=20,
    dp_fanSup=20,
    n_in=airHandlingUnit__AHU_150_n_in,
    n_out=airHandlingUnit__AHU_150_n_out,
    dp1_nominal=120,
    dp2_nominal=120,
    UA=236.11129999999997) annotation(Placement(transformation(extent={{1348.0,1368.0},{1368.0,1388.0}})));
  UnitTests.Confidential.SimpleAhu airHandlingUnit__AHU_152(
    fanRet(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_152.dp_fanSup),
       fanSup(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_152.dp_fanRet),
    use_on_in=true,
    redeclare package Medium=MediumAir,
    addDummyEquation=addDummyEquation,
    m1_flow_nominal=0.0416667,
    ...
    dp_fanRet=20,
    dp_fanSup=20,
    n_in=airHandlingUnit__AHU_152_n_in,
    n_out=airHandlingUnit__AHU_152_n_out,
    dp1_nominal=120,
    dp2_nominal=120,
    UA=236.11129999999997) annotation(Placement(transformation(extent={{1348.0,1418.0},{1368.0,1438.0}})));
  UnitTests.Confidential.SimpleAhu airHandlingUnit__AHU_154(
    fanRet(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_154.dp_fanSup),
       fanSup(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_154.dp_fanRet),
    use_on_in=true,
    redeclare package Medium=MediumAir,
    addDummyEquation=addDummyEquation,
    m1_flow_nominal=0.0416667,
    ...
    dp_fanRet=20,
    dp_fanSup=20,
    n_in=airHandlingUnit__AHU_154_n_in,
    n_out=airHandlingUnit__AHU_154_n_out,
    dp1_nominal=120,
    dp2_nominal=120,
    UA=236.11129999999997) annotation(Placement(transformation(extent={{1348.0,1468.0},{1368.0,1488.0}})));
  UnitTests.Confidential.SimpleAhu airHandlingUnit__AHU_156(
    fanRet(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_156.dp_fanSup),
       fanSup(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_156.dp_fanRet),
    use_on_in=true,
    redeclare package Medium=MediumAir,
    addDummyEquation=addDummyEquation,
    m1_flow_nominal=0.0416667,
    ...
    dp_fanRet=20,
    dp_fanSup=20,
    n_in=airHandlingUnit__AHU_156_n_in,
    n_out=airHandlingUnit__AHU_156_n_out,
    dp1_nominal=120,
    dp2_nominal=120,
    UA=236.11129999999997) annotation(Placement(transformation(extent={{1348.0,1518.0},{1368.0,1538.0}})));
  UnitTests.Confidential.SimpleAhu airHandlingUnit__AHU_158(
    fanRet(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_158.dp_fanSup),
       fanSup(inputType=UnitTests.Confidential.BaseClasses.InputType.Continuous,
           dp_in=weeklyProfile__Always_on.y * airHandlingUnit__AHU_158.dp_fanRet),
    use_on_in=true,
    redeclare package Medium=MediumAir,
    addDummyEquation=addDummyEquation,
    m1_flow_nominal=0.0416667,
    ...
    dp_fanRet=20,
    dp_fanSup=20,
    n_in=airHandlingUnit__AHU_158_n_in,
    n_out=airHandlingUnit__AHU_158_n_out,
    dp1_nominal=120,
    dp2_nominal=120,
    UA=236.11129999999997) annotation(Placement(transformation(extent={{1348.0,1568.0},{1368.0,1588.0}})));
  ...
  record material__Screed = IDEAS.Buildings.Data.Interfaces.Material (k=0.45, c=840, rho=1100, epsLw=0.88, epsSw=0.55, gas=false) "Screed";
  ...
  // final declarations:
  final parameter Integer airHandlingUnit__AHU_136_n_in = 3 "Number of connections to inlet port of airHandlingUnit__AHU_136";
  final parameter Integer airHandlingUnit__AHU_136_n_out = 2 "Number of connections to outlet port of airHandlingUnit__AHU_136";
  final parameter Integer airHandlingUnit__AHU_138_n_in = 3 "Number of connections to inlet port of airHandlingUnit__AHU_138";
  final parameter Integer airHandlingUnit__AHU_138_n_out = 2 "Number of connections to outlet port of airHandlingUnit__AHU_138";
  final parameter Integer airHandlingUnit__AHU_140_n_in = 3 "Number of connections to inlet port of airHandlingUnit__AHU_140";
  final parameter Integer airHandlingUnit__AHU_140_n_out = 2 "Number of connections to outlet port of airHandlingUnit__AHU_140";
  final parameter Integer airHandlingUnit__AHU_142_n_in = 3 "Number of connections to inlet port of airHandlingUnit__AHU_142";
  final parameter Integer airHandlingUnit__AHU_142_n_out = 2 "Number of connections to outlet port of airHandlingUnit__AHU_142";
  final parameter Integer airHandlingUnit__AHU_144_n_in = 3 "Number of connections to inlet port of airHandlingUnit__AHU_144";
  final parameter Integer airHandlingUnit__AHU_144_n_out = 2 "Number of connections to outlet port of airHandlingUnit__AHU_144";
  final parameter Integer airHandlingUnit__AHU_146_n_in = 3 "Number of connections to inlet port of airHandlingUnit__AHU_146";
  final parameter Integer airHandlingUnit__AHU_146_n_out = 2 "Number of connections to outlet port of airHandlingUnit__AHU_146";
  final parameter Integer airHandlingUnit__AHU_148_n_in = 3 "Number of connections to inlet port of airHandlingUnit__AHU_148";
  final parameter Integer airHandlingUnit__AHU_148_n_out = 2 "Number of connections to outlet port of airHandlingUnit__AHU_148";
  final parameter Integer airHandlingUnit__AHU_150_n_in = 3 "Number of connections to inlet port of airHandlingUnit__AHU_150";
  final parameter Integer airHandlingUnit__AHU_150_n_out = 2 "Number of connections to outlet port of airHandlingUnit__AHU_150";
  final parameter Integer airHandlingUnit__AHU_152_n_in = 3 "Number of connections to inlet port of airHandlingUnit__AHU_152";
  final parameter Integer airHandlingUnit__AHU_152_n_out = 2 "Number of connections to outlet port of airHandlingUnit__AHU_152";
  final parameter Integer airHandlingUnit__AHU_154_n_in = 3 "Number of connections to inlet port of airHandlingUnit__AHU_154";
  final parameter Integer airHandlingUnit__AHU_154_n_out = 2 "Number of connections to outlet port of airHandlingUnit__AHU_154";
  final parameter Integer airHandlingUnit__AHU_156_n_in = 3 "Number of connections to inlet port of airHandlingUnit__AHU_156";
  final parameter Integer airHandlingUnit__AHU_156_n_out = 2 "Number of connections to outlet port of airHandlingUnit__AHU_156";
  final parameter Integer airHandlingUnit__AHU_158_n_in = 3 "Number of connections to inlet port of airHandlingUnit__AHU_158";
  final parameter Integer airHandlingUnit__AHU_158_n_out = 2 "Number of connections to outlet port of airHandlingUnit__AHU_158";
  ...
  final parameter Integer tank__Tank_HP_n_outlet = 1 "Number of connections to inlet port of tank__Tank_HP_n_outlet";
initial equation
...
equation
  ...
  connect(realToBoolean__1.y,airHandlingUnit__AHU_136.on_in);
  connect(realToBoolean__10.u,weeklyProfile__Always_on.y);
  connect(realToBoolean__10.y,airHandlingUnit__AHU_154.on_in);
  connect(realToBoolean__11.u,weeklyProfile__Always_on.y);
  connect(realToBoolean__11.y,airHandlingUnit__AHU_156.on_in);
  connect(realToBoolean__12.u,weeklyProfile__Always_on.y);
  connect(realToBoolean__12.y,airHandlingUnit__AHU_158.on_in);
  connect(realToBoolean__2.u,weeklyProfile__Always_on.y);
  connect(realToBoolean__2.y,airHandlingUnit__AHU_138.on_in);
  connect(realToBoolean__3.u,weeklyProfile__Always_on.y);
  connect(realToBoolean__3.y,airHandlingUnit__AHU_140.on_in);
  connect(realToBoolean__4.u,weeklyProfile__Always_on.y);
  connect(realToBoolean__4.y,airHandlingUnit__AHU_142.on_in);
  connect(realToBoolean__5.u,weeklyProfile__Always_on.y);
  connect(realToBoolean__5.y,airHandlingUnit__AHU_144.on_in);
  connect(realToBoolean__6.u,weeklyProfile__Always_on.y);
  connect(realToBoolean__6.y,airHandlingUnit__AHU_146.on_in);
  connect(realToBoolean__7.u,weeklyProfile__Always_on.y);
  connect(realToBoolean__7.y,airHandlingUnit__AHU_148.on_in);
  connect(realToBoolean__8.u,weeklyProfile__Always_on.y);
  connect(realToBoolean__8.y,airHandlingUnit__AHU_150.on_in);
  connect(realToBoolean__9.u,weeklyProfile__Always_on.y);
  connect(realToBoolean__9.y,airHandlingUnit__AHU_152.on_in);
