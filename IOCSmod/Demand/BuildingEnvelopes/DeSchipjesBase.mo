...
model DeSchipjesBase
  ...
  output Modelica.Units.SI.Power Q_flow_borefield__BEO = borefield__BEO.Q_flow "borefield__BEO thermal power";
  ...
  output Modelica.Units.SI.Power Q_flow_circulationPumpDp__Pump_BEO = circulationPumpDp__Pump_BEO.Q_flow "circulationPumpDp__Pump_BEO thermal power";
  output Modelica.Units.SI.Power Q_flow_circulationPumpDp__Pump_DH = circulationPumpDp__Pump_DH.Q_flow "circulationPumpDp__Pump_DH thermal power";
  output Modelica.Units.SI.Power Q_flow_circulationPumpDp__Pump_HP = circulationPumpDp__Pump_HP.Q_flow "circulationPumpDp__Pump_HP thermal power";
  ...
  output Real PEl_Schema_DeSchipjes = obj__PEl_heatPump__HP_BW45
  + obj__PRet_airHandlingUnit__AHU_136
  ...
  + obj__P_circulationPumpDp__Pump_158
  + obj__P_circulationPumpDp__Pump_BEO
  + obj__P_circulationPumpDp__Pump_DH
  + obj__P_circulationPumpDp__Pump_HP "Total electrical power for 'Schema_DeSchipjes'";
    output Real TSet = 21;
  ...
  output Real PEl_heatPump__HP_BW45 = heatPump__HP_BW45.PEl "";
  ...
  output Real on_circulationPumpDp__Pump_BEO = if circulationPumpDp__Pump_BEO.port_a1.m_flow > 0.074074 then 1 else 0 "";
  output Real on_circulationPumpDp__Pump_DH = if circulationPumpDp__Pump_DH.port_a1.m_flow > 0.05740733333333334 then 1 else 0 "";
  output Real on_circulationPumpDp__Pump_HP = if circulationPumpDp__Pump_HP.port_a1.m_flow > 0.043333333333333335 then 1 else 0 "";
  ...
  IDEAS.Fluid.FixedResistances.PressureDrop supplyCav_zone__158_woonruimte__CAVs_type_living(
    ...
    from_dp=true,
    dp_nominal=20);
  IDEAS.Fluid.HeatExchangers.PrescribedOutlet borefield__BEO(
    redeclare package Medium=MediumWater,
    use_X_wSet=false,
    TSet=Modelica.Units.Conversions.from_degC(11),
    m_flow_nominal=3.588516746411483,
    dp_nominal=100000) annotation(Placement(transformation(extent={{1348.0,-182.0},{1368.0,-162.0}})));
  ...
  UnitTests.Circuits.CircuitExpansionVessel pressurizer__Pressurizer_BEO(
    redeclare package Medium = MediumWater) annotation(Placement(transformation(extent={{1448.0,-182.0},{1468.0,-162.0}})));
  UnitTests.Circuits.CircuitExpansionVessel pressurizer__Pressurizer_DH(
    redeclare package Medium = MediumWater) annotation(Placement(transformation(extent={{1648.0,-182.0},{1668.0,-162.0}})));
  ...
  UnitTests.Circuits.CircuitPumpDp circulationPumpDp__Pump_BEO(
    etaMotPar=1,
    etaHydPar=0.5,
    redeclare package Medium=MediumWater,
    inputType=UnitTests.Confidential.BaseClasses.InputType.Optimize,
    m_flow_nominal=2.22222,
    dp_nominal=60000.0,
    dp_min=60000.0,
    dpFixed_nominal=0,
    addDummyEquation=addDummyEquation) annotation(Placement(transformation(extent={{1398.0,-182.0},{1418.0,-162.0}})));
  UnitTests.Circuits.CircuitPumpDp circulationPumpDp__Pump_DH(
    etaMotPar=1,
    etaHydPar=0.5,
    redeclare package Medium=MediumWater,
    inputType=UnitTests.Confidential.BaseClasses.InputType.Optimize,
    m_flow_nominal=1.72222,
    dp_nominal=36000.0,
    dp_min=36000.0,
    dpFixed_nominal=0,
    addDummyEquation=addDummyEquation) annotation(Placement(transformation(extent={{1698.0,-182.0},{1718.0,-162.0}})));
  UnitTests.Circuits.CircuitPumpDp circulationPumpDp__Pump_HP(
    etaMotPar=1,
    etaHydPar=0.5,
    redeclare package Medium=MediumWater,
    inputType=UnitTests.Confidential.BaseClasses.InputType.Optimize,
    ...
    dp_min=10400.0,
    dpFixed_nominal=0,
    addDummyEquation=addDummyEquation) annotation(Placement(transformation(extent={{1548.0,-182.0},{1568.0,-162.0}})));
  ...
  UnitTests.Components.RadiatorEN442_2 radiator_zone__158_woonruimte__Radiator_1650500172(
    ...
    T_b_nominal=Modelica.Units.Conversions.from_degC(35.0),
    dp_nominal=5000);
  UnitTests.Confidential.HeatPump_WaterWater heatPump__HP_BW45(
    redeclare package Medium1=MediumWater,
    redeclare package Medium2=MediumWater,
    addDummyEquation=addDummyEquation,
    copDef=5.5,
    coeffCon={-273.15 - 35, -0.11},
    coeffEva={-273.15 -7, 0.11},
    m1_flow_nominal=2.94444,
    m2_flow_nominal=1.02778,
    dp_nominalEva=37000,
    dp_nominalCon=6500,
    eva(energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState),
    con(energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState),
    dT_max=8) annotation(Placement(transformation(extent={{1498.0,-182.0},{1518.0,-162.0}})));
  ...
  UnitTests.Confidential.Tank tank__Tank_HP(
    m_flow_nominal=3.3333333333333335,
    V=1,
    n_outlets=tank__Tank_HP_n_outlet,
    T_start=Modelica.Units.Conversions.from_degC(40),
    redeclare replaceable package Medium=MediumWater) annotation(Placement(transformation(extent={{1598.0,-182.0},{1618.0,-162.0}})));
...
equation
  ...
  connect(circulationPumpDp__Pump_BEO.port_a1,borefield__BEO.port_b);
  connect(circulationPumpDp__Pump_BEO.port_b1,borefield__BEO.port_a);
  connect(circulationPumpDp__Pump_DH.port_a1,pressurizer__Pressurizer_DH.port_b2);
  connect(circulationPumpDp__Pump_DH.port_b1,pressurizer__Pressurizer_DH.port_a2);
  connect(circulationPumpDp__Pump_HP.port_a1,heatPump__HP_BW45.port_b2);
  connect(circulationPumpDp__Pump_HP.port_b1,heatPump__HP_BW45.port_a2);
  connect(collector__HEXVAL_136.port_a1,circulationPumpDp__Pump_DH.port_b2);
  connect(collector__HEXVAL_136.port_b1,circulationPumpDp__Pump_DH.port_a2);
  connect(collector__HEXVAL_138.port_a1,circulationPumpDp__Pump_DH.port_b2);
  connect(collector__HEXVAL_138.port_b1,circulationPumpDp__Pump_DH.port_a2);
  connect(collector__HEXVAL_140.port_a1,circulationPumpDp__Pump_DH.port_b2);
  connect(collector__HEXVAL_140.port_b1,circulationPumpDp__Pump_DH.port_a2);
  connect(collector__HEXVAL_142.port_a1,circulationPumpDp__Pump_DH.port_b2);
  connect(collector__HEXVAL_142.port_b1,circulationPumpDp__Pump_DH.port_a2);
  connect(collector__HEXVAL_144.port_a1,circulationPumpDp__Pump_DH.port_b2);
  connect(collector__HEXVAL_144.port_b1,circulationPumpDp__Pump_DH.port_a2);
  connect(collector__HEXVAL_146.port_a1,circulationPumpDp__Pump_DH.port_b2);
  connect(collector__HEXVAL_146.port_b1,circulationPumpDp__Pump_DH.port_a2);
  connect(collector__HEXVAL_148.port_a1,circulationPumpDp__Pump_DH.port_b2);
  connect(collector__HEXVAL_148.port_b1,circulationPumpDp__Pump_DH.port_a2);
  connect(collector__HEXVAL_150.port_a1,circulationPumpDp__Pump_DH.port_b2);
  connect(collector__HEXVAL_150.port_b1,circulationPumpDp__Pump_DH.port_a2);
  connect(collector__HEXVAL_152.port_a1,circulationPumpDp__Pump_DH.port_b2);
  connect(collector__HEXVAL_152.port_b1,circulationPumpDp__Pump_DH.port_a2);
  connect(collector__HEXVAL_154.port_a1,circulationPumpDp__Pump_DH.port_b2);
  connect(collector__HEXVAL_154.port_b1,circulationPumpDp__Pump_DH.port_a2);
  connect(collector__HEXVAL_156.port_a1,circulationPumpDp__Pump_DH.port_b2);
  connect(collector__HEXVAL_156.port_b1,circulationPumpDp__Pump_DH.port_a2);
  connect(collector__HEXVAL_158.port_a1,circulationPumpDp__Pump_DH.port_b2);
  connect(collector__HEXVAL_158.port_b1,circulationPumpDp__Pump_DH.port_a2);
  ...
  connect(heatPump__HP_BW45.port_a1,pressurizer__Pressurizer_BEO.port_b2);
  connect(heatPump__HP_BW45.port_b1,pressurizer__Pressurizer_BEO.port_a2);
  ...
  connect(pressurizer__Pressurizer_BEO.port_a1,circulationPumpDp__Pump_BEO.port_b2);
  connect(pressurizer__Pressurizer_BEO.port_b1,circulationPumpDp__Pump_BEO.port_a2);
  connect(pressurizer__Pressurizer_DH.port_a1,tank__Tank_HP.ports_b[1]);
  connect(pressurizer__Pressurizer_DH.port_b1,tank__Tank_HP.ports_a[1]);
  ...
  connect(tank__Tank_HP.port_a1,circulationPumpDp__Pump_HP.port_b2);
  connect(tank__Tank_HP.port_b1,circulationPumpDp__Pump_HP.port_a2);
