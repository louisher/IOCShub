...
equation
  ...
  connect(P_appliances_profile.y[1], sum1.u[1]) annotation (Line(points={{-29,42},
          {-26,42},{-26,1},{-40,1}}, color={0,0,127}));
  connect(pv.P, sum1.u[2])
    annotation (Line(points={{-11,0},{-40,-1}}, color={0,0,127}));
