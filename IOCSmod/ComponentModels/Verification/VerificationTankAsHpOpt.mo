...
equation
  ...
  connect(tan.ports[2], AsHp.port_b) annotation (Line(points={{-1.6,0},{-1.6,-16},
          {-50,-16},{-50,-2}}, color={0,127,255}));
  connect(tan.ports[3], buildings.port_a) annotation (Line(points={{0,0},{2,0},{
          2,-24},{46,-24},{46,0}}, color={0,127,255}));
  connect(buildings.port_b, tan.ports[4]) annotation (Line(points={{34,0},{34,-14},
          {1.6,-14},{1.6,0}}, color={0,127,255}));
  connect(bou1.ports[1], tan.ports[5]) annotation (Line(points={{-84,6},{-84,-18},
          {-4,-18},{-4,0},{3.2,0}}, color={0,127,255}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)));
end VerificationTankAsHpOpt;
