...
equation
  connect(stc.port_a, vol.ports[1]) annotation (Line(points={{-38,-2},{-38,-12},
          {25.3333,-12},{25.3333,0}}, color={0,127,255}));
  connect(stc.port_b, vol.ports[2]) annotation (Line(points={{-50,-2},{-50,-20},
          {28,-20},{28,0}}, color={0,127,255}));
  connect(bou1.ports[1], vol.ports[3]) annotation (Line(points={{-62,-58},{-18,
          -58},{-18,-60},{30.6667,-60},{30.6667,0}},
                                                color={0,127,255}));
