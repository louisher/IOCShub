within IOCSmod.ComponentModels.Thermal.Borefields.Examples;
model Loadprofile
  ...
  TwoUTubes_Cont borefield(
    ...
    redeclare package Medium = IDEAS.Media.Water,
    redeclare parameter
      IOCSmod.ComponentModels.Thermal.Borefields.BaseClasses.HeatTransfer.Data.RCelPlayAround
      rCel,
    redeclare parameter
      IOCSmod.ComponentModels.Thermal.Borefields.BaseClasses.HeatTransfer.Data.KappaPlayAround
