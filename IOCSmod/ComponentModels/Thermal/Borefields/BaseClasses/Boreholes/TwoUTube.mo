within IOCSmod.ComponentModels.Thermal.Borefields.BaseClasses.Boreholes;
model TwoUTube "Double U-tube borehole heat exchanger"
  ...
  IOCSmod.ComponentModels.Thermal.Borefields.BaseClasses.Boreholes.BaseClasses.InternalHEXTwoUTube
    intHex[nSeg](
