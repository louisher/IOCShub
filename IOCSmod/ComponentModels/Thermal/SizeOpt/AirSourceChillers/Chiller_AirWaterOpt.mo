within IOCSmod.ComponentModels.Thermal.SizeOpt.AirSourceChillers;
model Chiller_AirWaterOpt
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y=Chi.m1_flow*cp_water/
        cp_air)                                                              annotation (
  ...
  IOCSmod.ComponentModels.Thermal.AirSourceChillers.Chiller_AirWaterInside Chi(
