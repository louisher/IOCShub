...
<p>Partial model to implement the inner resistance network of a borehole segment. </p>
<p>The partial model uses a thermal port representing a uniform borehole wall for that segment, and at least two other thermal ports (one for each tube going through the borehole segment). </p>
<p><br><b>To allow parameter optimization:</b></p>
<p>- Made hSeg an input parameter.</p>
</html>", revisions="<html>
<ul>
<li>
July 24, 2025, by Louis Hermans:<br/>
Made hSeg an input parameter.
</li>
<li>
