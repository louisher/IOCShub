...
partial model PartialBorehole
  ...
  parameter input Modelica.Units.SI.Length depth
...
<p>Partial model to implement models simulating geothermal U-tube boreholes modeled as several borehole segments, with a uniform borehole wall boundary condition. </p>
<p><br><b>To allow parameter optimization:</b></p>
<p>- Added input parameter depth.</p>
</html>", revisions="<html>
<ul>
<li>July 24, 2025, by Louis Hermans:<br>Added the input parameter depth.</li>
...
<li>July 5, 2018, by Alex Laferri&egrave;re:<br>First implementation of partial model. </li>
