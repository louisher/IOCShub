...
model EightPortHeatMassExchanger
  ...
  parameter input Modelica.Units.SI.Time tau1=30 "Time constant at nominal flow"
    annotation (Dialog(tab="Dynamics", group="Nominal condition"));
  parameter input Modelica.Units.SI.Time tau2=30 "Time constant at nominal flow"
    annotation (Dialog(tab="Dynamics", group="Nominal condition"));
  parameter input Modelica.Units.SI.Time tau3=30 "Time constant at nominal flow"
    annotation (Dialog(tab="Dynamics", group="Nominal condition"));
  parameter input Modelica.Units.SI.Time tau4=30 "Time constant at nominal flow"
    annotation (Dialog(tab="Dynamics", group="Nominal condition"));
  ...
  IOCSmod.ComponentModels.Thermal.SizeOpt.Tank.MixingVolumeOpt vol1(
  ...
  IOCSmod.ComponentModels.Thermal.SizeOpt.Tank.MixingVolumeOpt vol2(
  ...
  IOCSmod.ComponentModels.Thermal.SizeOpt.Tank.MixingVolumeOpt vol3(
   ...
   annotation (Placement(transformation(
        ...
        extent={{10,10},{-10,-10}},
        rotation=180)));
  IOCSmod.ComponentModels.Thermal.SizeOpt.Tank.MixingVolumeOpt vol4(
...
<p>- Mixingvolumes are changed to optimizable ones, setting of energy- and massDynamics based on tau is removed. </p>
<p>- tau&apos;s are made input parameters</p>
</html>", revisions="<html>
<ul>
<li>July 24, 2025, by Louis Hermans:<br>Made tau&apos;s input parameters, changed mixing volumes, removed tau-based setting of dynamics in mixing volumes. </li>
<li>April 14, 2020, by Michael Wetter:<br>Changed <span style=\"font-family: Courier New;\">homotopyInitialization</span> to a constant.<br>This is for <a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/1341\">IDEAS, #1341</a>. </li>
<li>July 18, 2018, by Massimo Cimmino:<br>Remove start values of m_flow and dp variables. </li>
