...
model HeatPump_AirWater
  ...
  parameter Modelica.Units.SI.Power Q_flow_nominal "Nominal heat flow rate";
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y = m1_flow_nominal) annotation (
  ...
  IOCSmod.ComponentModels.Thermal.AirSourceHeatPumps.HeatPump_AirWaterInside HP(
    ...
    dT_max=Q_flow_nominal/m2_flow_nominal/4180,
