...
model EN12975 "Model of a solar thermal collector according to the ASHRAE Standard 93"
  extends IOCSmod.ComponentModels.Thermal.SolarCollectors.BaseClasses.PartialSolarCollector(
   ...
   IOCSmod.ComponentModels.Thermal.SolarCollectors.BaseClasses.EN12975SolarGain solGai(
  ...
  IOCSmod.ComponentModels.Thermal.SolarCollectors.BaseClasses.EN12975HeatLoss heaLos(
    redeclare package Medium = Medium,
    final nSeg=nSeg,
    final a1=per.a1,
    final a2=per.a2,
