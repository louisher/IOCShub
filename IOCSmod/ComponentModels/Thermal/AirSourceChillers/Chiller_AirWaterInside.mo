...
model Chiller_AirWaterInside
  "Chiller model inside the air water chiller model"
  extends
    IOCSmod.ComponentModels.Thermal.AirSourceChillers.Chiller_AirWaterInsideBase(
  ...
  Modelica.Blocks.Interfaces.RealOutput OutputTEvaIn
