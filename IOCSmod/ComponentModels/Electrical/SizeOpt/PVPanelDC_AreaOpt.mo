...
model PVPanelDC_AreaOpt
  "Model for a photovoltaic installation which has a power output (DC)"

  parameter input Modelica.Units.SI.Area Size "Size of the PV installation in m2" annotation(Dialog(group="Optimal sizing"));
...
protected
  parameter input Modelica.Units.SI.Area PVArea=Size "Total area of the entire field"
  annotation (Dialog(group="Characteristics of the photovoltaic installation"));
  parameter input Real n(min=0)=PVArea/Apanel "Number of photovoltaic panels in the photovoltaic installation"
    annotation (Dialog(group="Characteristics of the photovoltaic installation"));
