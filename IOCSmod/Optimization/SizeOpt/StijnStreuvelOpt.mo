...
model StijnStreuvelOpt
  extends IOCSmod.Optimization.Interface(sim(incAndAziInBus={{IDEAS.Types.Tilt.Ceiling,
  ...
  IOCSmod.Blocks.Demand.Clusters.StijnStreuvel buildings(addDummyEquation=
        addDummyEquation)
