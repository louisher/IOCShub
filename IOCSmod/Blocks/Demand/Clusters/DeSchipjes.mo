...
model DeSchipjes
  ...
  final parameter Modelica.Units.SI.PressureDifference dp_network_nominal=36000 "Nominal pump head of the primary circulation pump";

  final parameter Modelica.Units.SI.MassFlowRate m_flow_network_nominal=1.7222
    "Nominal mass flow rate at the heat generation side of the thermal network";

  IOCSmod.Demand.BuildingModels.DeSchipjes    Houses(addDummyEquation=
        addDummyEquation, redeclare package MediumWater = Medium)
