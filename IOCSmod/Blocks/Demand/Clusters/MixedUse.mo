...
model MixedUse
  ...
  final parameter Modelica.Units.SI.PressureDifference dp_network_nominal=3*Houses.dp_nom_NET "Nominal pump head of the primary circulation pump";
  ...
  IOCSmod.Demand.BuildingModels.MixedUse Houses(addDummyEquation=
        addDummyEquation)
