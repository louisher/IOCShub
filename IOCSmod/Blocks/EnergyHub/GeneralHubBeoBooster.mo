...
model GeneralHubBeoBooster

  extends BaseClasses.EnergyHubInterface;

  /* GSHP parameters */
  parameter Real Size_GsHp "Nominal heat flow rate of GSHP in kW" annotation(Dialog(tab="GSHP", group="Heat flows"));
  parameter Modelica.Units.SI.HeatFlowRate Qnom_Bor= Qnom_GsHp*(3/4) annotation(Dialog(tab="GSHP", group="Heat flows"));

  parameter Modelica.Units.SI.MassFlowRate m_flow_gshp_nominal= Qnom_GsHp/4180/dT_max "Nominal mass flow gshp condensor" annotation(Dialog(tab="GSHP", group="Mass flows"));
  ...
  /* ASHP parameters */
  parameter Real Size_AsHp "Nominal heat flow rate of ASHP in kW" annotation(Dialog(tab="ASHP"));
  parameter Modelica.Units.SI.MassFlowRate m_flow_ashp_nominal= Qnom_AsHp/4180/5 "Nominal mass flow rate at water side" annotation(Dialog(tab="ASHP"));
  ...
  parameter Modelica.Units.SI.MassFlowRate m_flow_aschi_nominal=AsChi.Qnom_AsChi/4180/5 "Nominal mass flow rate at water side" annotation(Dialog(tab="CHILLER"));
  ...
  /* Tank parameters */
  parameter Modelica.Units.SI.MassFlowRate m_flow_tank_nominal=m_flow_ashp_nominal + m_flow_gshp_nominal "Nominal mass flow rate" annotation(Dialog(tab="Tank"));
  parameter Modelica.Units.SI.Volume Size_Tank=0.950 "Volume of the water tank" annotation(Dialog(tab="Tank"));

  /* PV parameters */
  parameter Modelica.Units.SI.Area Size_PV=0.01 "Total area of the entire field" annotation (Dialog(tab="PV", group="Characteristics of the photovoltaic installation"));
  ...
  parameter Real Size_Bat=10 "Maximal storage capacity of battery in kWh" annotation(Dialog(tab="Battery", group="Battery settings", enable=hasBat));
  ...
  parameter Real SoC_start=0.5 "Initial state of charge (between 0 and 1)" annotation(Dialog(tab="Battery", group="Initialistion settings", enable=hasBat));
  ...
  /* STC parameters */
  parameter Modelica.Units.SI.Area Size_STC "Total area of panels in the simulation" annotation (Dialog(tab="STC", group="General"));
  ...
  parameter Modelica.Units.SI.MassFlowRate m_flow_stc_nominal=per_STC.mperA_flow_nominal*Size_STC "Nominal mass flow rate in stc panels" annotation (Dialog(tab="STC", group="General"));
  ...
  /* PVT parameters */
  parameter Modelica.Units.SI.Area Size_PVT "Total area of panels in the simulation" annotation (Dialog(tab="PVT", group="General"));
  ...
  parameter Modelica.Units.SI.MassFlowRate m_flow_pvt_nominal=per_PVT.mperA_flow_nominal*Size_PVT "Nominal mass flow rate in stc panels" annotation (Dialog(tab="PVT", group="General"));
  ...
  ComponentModels.Thermal.GsHp GsHp(addDummyEquation=addDummyEquation, redeclare
    ...
    hasReg=true,
    Qnom_GsHp=Qnom_GsHp,
    m_flow_gshp_nominal=m_flow_gshp_nominal,
  ...
  ComponentModels.Thermal.SimpleTank tan(addDummyEquation=addDummyEquation,
  ...
  ComponentModels.Electrical.LinearBattery bat(
    P_max=P_max_bat,
    EBat_max=EBat_max,
    effCha=effCha,
    effDisCha=effDisCha,
  ...
  ComponentModels.Thermal.Stc stc(
    ...
    m_flow_panels_nominal=m_flow_stc_nominal,
    dp_panels_nominal(displayUnit="Pa") = dp_stc_nominal,
  ...
  ComponentModels.Thermal.Pvt pvt(
    ...
    m_flow_panels_nominal=m_flow_pvt_nominal,
    dp_panels_nominal=dp_pvt_nominal,
  ...
  ComponentModels.Thermal.AsChi AsChi(addDummyEquation=addDummyEquation,
    redeclare replaceable package Medium = Medium,
    Qnom_AsChi=Qnom_AsChi,
    m_flow_aschi_nominal=m_flow_aschi_nominal,
    EERDef=EERDef,
...
protected
  ...
  parameter Modelica.Units.SI.Power Qnom_AsChi = Size_AsChi*1000 "Nominal cooling capacity of chiller(positive value)" annotation(Dialog(tab="CHILLER"));
