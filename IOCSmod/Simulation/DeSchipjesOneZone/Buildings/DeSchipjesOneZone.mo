...
model DeSchipjesOneZone
  ...
  Building                                    nr158(building_name="Peterselie6",
    occupantID=20,
    addDummyEquation=addDummyEquation)
    annotation (Placement(transformation(extent={{-170,60},{-190,80}})));
  Building                                    nr156(building_name="Peterselie5",
    occupantID=19,
    addDummyEquation=addDummyEquation)
    annotation (Placement(transformation(extent={{-120,60},{-140,80}})));
  Building                                    nr154(building_name="Peterselie4",
    occupantID=17,
    addDummyEquation=addDummyEquation)
    annotation (Placement(transformation(extent={{-60,60},{-80,80}})));
  Building                                    nr152(building_name="Peterselie3",
    occupantID=16,
    addDummyEquation=addDummyEquation)
    annotation (Placement(transformation(extent={{0,60},{-20,80}})));
  Building                                    nr150(building_name="Peterselie2",
    occupantID=15,
    addDummyEquation=addDummyEquation)
  ...
  Modelica.Blocks.Sources.RealExpression TotDiscmf(y=nr158.heatingSystem.Discmf.y
         + nr156.heatingSystem.Discmf.y + nr154.heatingSystem.Discmf.y + nr152.heatingSystem.Discmf.y
         + nr150.heatingSystem.Discmf.y + nr148.heatingSystem.Discmf.y + nr146.heatingSystem.Discmf.y
         + nr144.heatingSystem.Discmf.y + nr142.heatingSystem.Discmf.y + nr140.heatingSystem.Discmf.y
         + nr138.heatingSystem.Discmf.y + nr136.heatingSystem.Discmf.y)
    annotation (Placement(transformation(extent={{100,-130},{120,-110}})));
  Modelica.Blocks.Sources.RealExpression TotEbhp_kWhp(y=nr158.heatingSystem.EBhp_kWh.y
         + nr156.heatingSystem.EBhp_kWh.y + nr154.heatingSystem.EBhp_kWh.y +
        nr152.heatingSystem.EBhp_kWh.y + nr150.heatingSystem.EBhp_kWh.y + nr148.heatingSystem.EBhp_kWh.y
         + nr146.heatingSystem.EBhp_kWh.y + nr144.heatingSystem.EBhp_kWh.y +
        nr142.heatingSystem.EBhp_kWh.y + nr140.heatingSystem.EBhp_kWh.y + nr138.heatingSystem.EBhp_kWh.y
         + nr136.heatingSystem.EBhp_kWh.y)
    annotation (Placement(transformation(extent={{140,-130},{160,-110}})));
  IDEAS.Fluid.FixedResistances.Junction junRet158(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    portFlowDirection_1=Modelica.Fluid.Types.PortFlowDirection.Entering,
    portFlowDirection_2=Modelica.Fluid.Types.PortFlowDirection.Leaving,
    portFlowDirection_3=Modelica.Fluid.Types.PortFlowDirection.Entering,
    m_flow_nominal={m_flow_nom_house,-m_flow_nom_house,m_flow_nom_bypass},
    dp_nominal={0,0,0}) annotation (Placement(transformation(
        extent={{-5,5},{5,-5}},
        rotation=270,
        origin={-200,44})));
  IDEAS.Fluid.Actuators.Valves.TwoWayLinear     valveBypass(
    use_inputFilter=true,
    redeclare package Medium = Medium,
    allowFlowReversal=false,
    m_flow_nominal=m_flow_nom_bypass,
    from_dp=true,
    CvData=IDEAS.Fluid.Types.CvTypes.Kv,
    Kv=valveBypass.m_flow_nominal*3.6/(4.843*9.81*Medium.d_const/1e5)^(1/2))
                           annotation (Placement(transformation(
        extent={{5,5},{-5,-5}},
        rotation=0,
        origin={-180,44})));
  IDEAS.Fluid.FixedResistances.Junction junSup158(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    portFlowDirection_1=Modelica.Fluid.Types.PortFlowDirection.Entering,
    portFlowDirection_2=Modelica.Fluid.Types.PortFlowDirection.Leaving,
    ...
    dp_nominal={0,0,0}) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-160,44})));
  IDEAS.Controls.Continuous.LimPID conValveBypass(
    k=1/m_flow_nom_bypass,
    Ti=120,
    strict=false)
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},
        rotation=270,
        origin={-224,2})));
  Modelica.Blocks.Sources.RealExpression measuredMassFlow(y=pipeProduction136A.m1_flow)
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-244,-28})));
  Modelica.Blocks.Sources.RealExpression minimumMassFlow(y=m_flow_nom_bypass)
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-224,-28})));
equation
  ...
  connect(pipe156158.port_b1, junSup158.port_1) annotation (Line(points={{-170,
          16},{-176,16},{-176,30},{-160,30},{-160,39}}, color={0,127,255}));
  connect(junSup158.port_2, nr158.port_a) annotation (Line(points={{-160,49},{
          -160,54},{-178,54},{-178,60}}, color={0,127,255}));
  connect(junRet158.port_1, nr158.port_b) annotation (Line(points={{-200,49},{
          -200,56},{-182,56},{-182,60}}, color={0,127,255}));
  connect(junRet158.port_2, pipe156158.port_a2) annotation (Line(points={{-200,
          39},{-202,39},{-202,4},{-170,4}}, color={0,127,255}));
  connect(junRet158.port_3, valveBypass.port_b)
    annotation (Line(points={{-195,44},{-185,44}}, color={0,127,255}));
  connect(valveBypass.port_a, junSup158.port_3)
    annotation (Line(points={{-175,44},{-165,44}}, color={0,127,255}));
  connect(conValveBypass.y, valveBypass.y) annotation (Line(points={{-224,13},{
          -224,28},{-180,28},{-180,38}}, color={0,0,127}));
  connect(minimumMassFlow.y, conValveBypass.u_s)
    annotation (Line(points={{-224,-17},{-224,-10}}, color={0,0,127}));
  connect(measuredMassFlow.y, conValveBypass.u_m)
    annotation (Line(points={{-244,-17},{-244,2},{-236,2}}, color={0,0,127}));
